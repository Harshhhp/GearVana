...
import { Calendar, Car, Cog, Layout, LayoutDashboard } from 'lucide-react'
...
const Sidebar = () => {
  ...
  <div className='md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t flex justify-around items-center h-16'></div>
